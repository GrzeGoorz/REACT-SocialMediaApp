  ...
  const { mutate: deletePost, isPending: isDeletePending } = useMutation({
    mutationFn: async () => {
      try {
        ...
        if (!response.ok) {
          throw new Error(data.error || "Błąd usuwania posta");
        }
        return data;
      } catch (error) {
        console.error(error);
    ...
    onSuccess: () => {
      ...
      toast.success("Pomyslnie usunieto post!");
  ...
  const { mutate: likePost, isPending: isLikePending } = useMutation({
    mutationFn: async () => {
      try {
        ...
        const data = await response.json();
        if (!response.ok) {
          throw new Error(data.error || "Błąd polubienia posta");
        }
        return data;
      } catch (error) {
        console.error(error);
    ...
    onSuccess: (updatedLikes) => {
      ...
      toast.success("Pomyslnie polubiono post!");
